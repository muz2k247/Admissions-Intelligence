---
name: code-reviewer
description: Unbiased code review of a snippet with zero prior context. Returns actionable recommendations on correctness, readability, performance, security, and data-integrity compliance for the admissions pipeline.
model: sonnet
tools: Read, Write
---
